class World{
    ...
    new BackgroundObject('img/3. Background/Layers/5. Water/L1.png', 719*4),
    new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L2.png', 719*4),
    new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L2.png', 719*4),
   new BackgroundObject('img/3. Background/Layers/2. Floor/L2.png', 719*4),

   new BackgroundObject('img/3. Background/Layers/5. Water/L1.png', 719*5),
   new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L2.png', 719*5),
